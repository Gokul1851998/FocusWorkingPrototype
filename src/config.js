...
export const SideBarIcons = [
    ...
    { id: 30, parent:8, iconName: "General Settings", icon:  import("@mui/icons-material/Inventory"),url:"/GeneralSettings" },
    ...
    { id: 37, parent:9, iconName: "Edit Company", icon:  import("@mui/icons-material/Home"),url:"/Company" },
    // { id: 38, parent:9, iconName: "Delete Company", icon:  import("@mui/icons-material/Home"),url:"/DeleteCompany" },
    { id: 39, parent:8, iconName: "Entity Settings", icon:  import("@mui/icons-material/Inventory"),child:true },
    { id: 40,parent:39, iconName: "Finance", icon:  import("@mui/icons-material/PointOfSale") ,url:"/EntitySettings" },
    { id: 41, parent:39, iconName: "Inventory", icon:  import("@mui/icons-material/Inventory"),url:"/EntitySettings" },
    { id: 42, parent:39, iconName: "Fixed Asset", icon:  import("@mui/icons-material/Inventory"),url:"/EntitySettings" },
    { id: 43, parent:39, iconName: "General", icon:  import("@mui/icons-material/Inventory"),url:"/EntitySettings" },
    { id: 44, parent:8, iconName: "Configuration", icon:  import("@mui/icons-material/Inventory"),child:true },
    { id: 45, parent:44, iconName: "Voucher Configuration", icon:  import("@mui/icons-material/Inventory"),url:"/Configuration" },
    { id: 46, parent:44, iconName: "Master Configuration", icon:  import("@mui/icons-material/Inventory"),url:"/Configuration" },
    { id: 47, parent:44, iconName: "Views Configuration", icon:  import("@mui/icons-material/Inventory"),url:"/Configuration" },
    { id: 48, parent:44, iconName: "Work Flow", icon:  import("@mui/icons-material/Inventory"),url:"/Configuration" },
    { id: 49, parent:44, iconName: "VAT Configuration", icon:  import("@mui/icons-material/Inventory"),url:"/Configuration" },
