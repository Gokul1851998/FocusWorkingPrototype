...
export const SideBarIcons = [
    ...
    { id: 33,parent:30, iconName: "Tag Settings", icon:  import("@mui/icons-material/PointOfSale") ,url:"/TagSettings" },
    { id: 34, parent:30, iconName: "Account Settings", icon:  import("@mui/icons-material/Inventory"),url:"/AccountSettings" },
