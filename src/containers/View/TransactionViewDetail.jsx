...
import CustomizationView from "../Settings/MasterSettings/CustomizationView";
import CustomizationView1 from "../Settings/MasterSettings/CustomizationView1";
import CustomizationTransactionView from "../Settings/MasterSettings/CustomizationTransactionView";
...
const TransactionViewDetail = ({setPage,detailPageId,direction}) => {
        ...
        <AccordionDetails>
          <>
            <div>
              <MDBCardBody>
                <Box sx={{padding:2}}>
                <Typography sx={{ fontSize: "14px" }}>User/Role</Typography>
          <FormControlLabel
            control={
              <Switch
                checked={formData.isRole}
                onChange={handleToggleChange}
                color="primary"
                
              />
            }
            label={formData.isRole ? "Role" : "User"}
            sx={{ width: "200px" }}
          />
                </Box>
              
                <CustomizationTransactionView item={formData} />
              </MDBCardBody>
            </div>
          </>
        </AccordionDetails>
