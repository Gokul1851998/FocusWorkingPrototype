...
import MasterDefinition from "../../Settings/MasterSettings/MasterDefinition";
import SalesDefinition from "./SalesDefinition";
...
const SalesDetails = ({setPage,detailPageId,direction}) => {
...
<IconButton
            ...
            >
              <Stack direction="column" alignItems="center">
                <ArrowCircleLeftOutlinedIcon style={{ color: currentTheme.actionIcons, }} />
                <Typography
                  variant="caption"
                  align="center"
                  style={{fontSize: "0.6rem",color: currentTheme.actionIcons, }}
            ...
            >
              <Stack direction="column" alignItems="center">
                <ArrowCircleRightOutlinedIcon style={{ color: currentTheme.actionIcons, }} />
                <Typography
                  variant="caption"
                  align="center"
                  style={{fontSize: "0.6rem",color: currentTheme.actionIcons, }}
            ...
            >
              <Stack direction="column" alignItems="center">
        <PowerSettingsNewIcon sx={{ color: currentTheme.actionIcons, }} />
        <Typography
                  variant="caption"
                  align="center"
                  style={{ color: currentTheme.actionIcons, fontSize: "0.6rem" }}
        ...
        <Accordion
          ...
          >
            ...
            >
              <Typography style={{ fontSize: "14px" }}>Sales Invoice</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <>
              <MDBCardBody>
                ...
                <SalesDefinition detailPageId={detailPageId}/>
                </MDBCardBody>
              </>
            </AccordionDetails>
          </Accordion> 
