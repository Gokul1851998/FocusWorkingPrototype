...
import { EntityMasterTable, initialRows, SalesSummaryTable, TagCreationTable } from '../../../config/securityConfig';
    ...
    <Box sx={{ display: "flex", flexDirection: "row", gap: "5px",alignItems:"center" }}>
      ...
      <IconButton
        ...
        <Typography
            ...
            >
              <Stack direction="column" alignItems="center">
        <QrCode2Icon sx={{ color: currentTheme.actionIcons, }} />
        <Typography
                  variant="caption"
                  align="center"
                  style={{ color: currentTheme.actionIcons, fontSize: "0.6rem" }}
            ...
            >
              <Stack direction="column" alignItems="center">
        <SettingsIcon sx={{color: currentTheme.actionIcons, }} />
        <Typography
                  variant="caption"
                  align="center"
                  style={{ color: currentTheme.actionIcons, fontSize: "0.6rem" }}
...
const SalesSummary = ({setPage,setdetailPageId}) => {
