  ...
  return (
    <div>
      ...
      >
        ...
        >
          <Typography style={{ fontSize: "14px" }}>Account Properties</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <>
            <div>
              <MDBCardBody style={{margin:3, display:'flex',justifyContent:'space-around'}}>
                <Box sx={{mt:2}}>
                    <Typography sx={{border: true, fontWeight: 'bold'}}> Display In Ledger</Typography>
                    <Box sx={{ display: "flex", alignItems: "center", width: "200px" }}>
                            <FormControlLabel
                                value="Normal"
                                control={
                                    <Radio
                                        checked={formData1.searchBy === "Normal"}
                        ...
                        >
                            ...
                            <FormControlLabel
                                ...
                                label="Display Debit/Credit totals for each Account under group"
                            />
                            <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Club the transactions of all the Accounts under Group"
                            />
                            {/* <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Suspended Credit Limit "
                            /> */}
                            <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Display Un-Realize Gain/Loss In Ledger"
                            />
                            </Box>
                </Box>
                <Box sx={{mt:2}}>
                    <Typography sx={{border: true, fontWeight: 'bold'}}> Consolidation of Transactions</Typography>
                    <Box sx={{ display: "flex", alignItems: "center", width: "200px" }}>
                            <FormControlLabel
                                value="None"
                                control={
                                    <Radio
                                        checked={formData1.searchBy === "None"}
                                        onChange={handleRadioChange}
                                    />
                                }
                                label={
                        ...
                        >
                            ...
                            <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Consolidate when both Accounts are same "
                            />
                            <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Consolidate Always "
                            />
                            <FormControlLabel
                                control={<Checkbox checked={checkboxState.mobileApp} onChange={handleChange1} name="dateCanot" />}
                                label="Consolidate only inventory transactions "
                            />
