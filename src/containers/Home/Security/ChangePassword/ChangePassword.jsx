            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Stack direction="column" alignItems="center">
                                <LockResetIcon sx={{ color: primaryButtonColor }} />
                            </Stack>
                        </IconButton>
                                ...
                                <MDBCardBody>
                                    <MDBRow>
                                            ...
                                            <MDBCol lg="3" md="4" sm="6" xs="12">
                                                <SecurityInput label="Old Password" mandatory={1} />
                                            </MDBCol>
                                        
                                            <MDBCol lg="3" md="4" sm="6" xs="12">
                                                <SecurityInput label="New Password" mandatory={1} />
                                            </MDBCol>
                                            <MDBCol lg="3" md="4" sm="6" xs="12">
                                                <SecurityInput label="Confirm New Password" mandatory={1} />
                                            </MDBCol>
