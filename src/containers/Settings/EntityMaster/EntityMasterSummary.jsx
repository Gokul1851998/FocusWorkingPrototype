...
import { EntityMasterTable, initialRows } from '../../../config/securityConfig';
...
const EntityMasterSummary = ({setPage,setdetailPageId}) => {
...
export default EntityMasterSummary;
