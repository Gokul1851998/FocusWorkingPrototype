...
export default function FinanceSettings(args) {
        ...
        <Accordion
                      ...
                      <MDBCardBody>
                        <MDBCol>
                          <FormControlLabel
                            ...
                            label="Use credit days instead of due date for credit limit  check"
                            sx={{
                              "& .MuiFormControlLabel-label": {
                                fontSize: "0.9rem",
                                color: "gray",
                      ...
                      <MDBCardBody>
                        <MDBCol>
                          <FormControlLabel
                            ...
                            label="Do not include PDC in credit limit check"
                            sx={{
                              "& .MuiFormControlLabel-label": {
                                fontSize: "0.9rem",
                                color: "gray",
                      ...
                      <MDBCardBody>
                        ...
                        <MDBCol>
                          <FormControlLabel
                            ...
                            label="D not include PDC in credit limit check"
                            sx={{
                              "& .MuiFormControlLabel-label": {
                                fontSize: "0.9rem",
                                color: "gray",
                      ...
                      <MDBCardBody>
                        <MDBCol>
                          <FormControlLabel
                            ...
                            label="Enable bill wise account"
                            sx={{
                              "& .MuiFormControlLabel-label": {
                                fontSize: "0.9rem",
                                color: "gray",
          ...
          >
            <AccordionSummary
              ...
              currentTheme={currentTheme}
            >
              <Typography style={{ fontSize: "14px" }}>Miscellaneous</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <>
              <MDBRow>
