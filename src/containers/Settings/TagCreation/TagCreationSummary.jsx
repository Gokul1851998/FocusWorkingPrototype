...
import { EntityMasterTable, initialRows, TagCreationTable } from '../../../config/securityConfig';
...
const TagCreationSummary = ({setPage,setdetailPageId}) => {
...
export default TagCreationSummary;
