...
import { DropdownData, editLayoutProperties, fieldTypeData, propertiesData, TabtypeData } from "../../../../config/masterSettings";
...
export default function EditLayoutModal({ isOpen, handleCloseModal }) {
                    ...
                    <>
                      <div>
                        <MDBCardBody>
                          ...
                          {editLayoutProperties.map((item,index) =>(
                              <MDBCol key={index}>
